...
type DefaultAPI interface {
	...
	This also includes a few global elements, such as announcements, server reset dates and leaderboards.
		...
		@return DefaultAPIGetStatusRequest
	*/
	GetStatus(ctx context.Context) DefaultAPIGetStatusRequest

	// GetStatusExecute executes the request
	//  @return GetStatus200Response
	GetStatusExecute(r DefaultAPIGetStatusRequest) (*GetStatus200Response, *http.Response, error)
	...
	If you are new to SpaceTraders, It is recommended to register with the COSMIC faction, a faction that is well connected to the rest of the universe. After registering, you should try our interactive [quickstart guide](https://docs.spacetraders.io/quickstart/new-game) which will walk you through basic API requests in just a few minutes.
		...
		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@return DefaultAPIRegisterRequest
	*/
	Register(ctx context.Context) DefaultAPIRegisterRequest

	// RegisterExecute executes the request
	//  @return Register201Response
	RegisterExecute(r DefaultAPIRegisterRequest) (*Register201Response, *http.Response, error)
}

// DefaultAPIService DefaultAPI service
type DefaultAPIService service

type DefaultAPIGetStatusRequest struct {
	ctx        context.Context
	ApiService DefaultAPI
}

func (r DefaultAPIGetStatusRequest) Execute() (*GetStatus200Response, *http.Response, error) {
...
This also includes a few global elements, such as announcements, server reset dates and leaderboards.
	...
	@return DefaultAPIGetStatusRequest
*/
func (a *DefaultAPIService) GetStatus(ctx context.Context) DefaultAPIGetStatusRequest {
	return DefaultAPIGetStatusRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return GetStatus200Response
func (a *DefaultAPIService) GetStatusExecute(r DefaultAPIGetStatusRequest) (*GetStatus200Response, *http.Response, error) {
	var (
...
type DefaultAPIRegisterRequest struct {
	ctx             context.Context
	ApiService      DefaultAPI
	registerRequest *RegisterRequest
}

func (r DefaultAPIRegisterRequest) RegisterRequest(registerRequest RegisterRequest) DefaultAPIRegisterRequest {
	r.registerRequest = &registerRequest
	return r
}

func (r DefaultAPIRegisterRequest) Execute() (*Register201Response, *http.Response, error) {
...
If you are new to SpaceTraders, It is recommended to register with the COSMIC faction, a faction that is well connected to the rest of the universe. After registering, you should try our interactive [quickstart guide](https://docs.spacetraders.io/quickstart/new-game) which will walk you through basic API requests in just a few minutes.
	...
	@return DefaultAPIRegisterRequest
*/
func (a *DefaultAPIService) Register(ctx context.Context) DefaultAPIRegisterRequest {
	return DefaultAPIRegisterRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return Register201Response
func (a *DefaultAPIService) RegisterExecute(r DefaultAPIRegisterRequest) (*Register201Response, *http.Response, error) {
	var (
